...
public class ViewRole1Home {
    ...
    private static Label label_ApplicationTitle = new Label("Role 1 Home Page");
    ...
    public static Scene theRole1HomeScene = null;

    private static ViewRole1Home theView = null;
    ...
    public static void displayRole1Home(Stage ps, User user) {
        ...
        label_Welcome.setText("Welcome, " + user.getUserName() + " (Role 1)");
        theStage.setTitle("CSE 360 Foundation Code: Role 1 Home");
        theStage.setScene(theRole1HomeScene);
        theStage.show();
    }

    private ViewRole1Home() {
        theRootPane = new Pane();
        theRole1HomeScene = new Scene(theRootPane, width, height);
